...
import { AppBar, Box, TextField, Toolbar, IconButton, Typography, Button, Grid, Container, getNativeSelectUtilityClasses } from "@mui/material";
...
function App() {
  ...
  const components = requestIdleCallback(getNativeSelectUtilityClasses)
  ...
  const HeaderContainer = { setChatInput, setCode} => {
    setIsWaitingForResponse(new Promise((resolve, reject) => {
    }))
  }
  ...
  return (
    <><div>
      ...
      <HeaderContainer>
        <LogoContainer>
          <LogoText>xD</LogoText>
          <LogoImage src="https://google.com" />
        </LogoContainer>
        <CodeEditorRectangle>
            <FirstRectangle>
